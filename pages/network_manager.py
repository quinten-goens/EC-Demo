...
def app():
    ...
    col1.markdown("""The <t style="color:#149414"><b>green</b></t> and <t style="color:#FF0000"><b>red</b></t> colored metrics (see right) indicate <t style="color:#149414"><b>increases</b></t>  or <t style="color:#FF0000"><b>decreases</b></t> relative to same metric the previous year.""", unsafe_allow_html=True)
    col1.markdown("""<b>Note: As a network manager you might be interested in obtaining the raw data. You download the raw data here:</b>""",unsafe_allow_html=True)
    df_xlsx = to_excel(df)
    ...
    col2.metric("IFR flights 2019", millify(FLT_2019), delta=round(((FLT_2019-FLT_2018)/FLT_2018)*100,2), delta_color="normal")
    col2.metric("IFR flights 2020", millify(FLT_2020), delta=round(((FLT_2020-FLT_2019)/FLT_2019)*100,2), delta_color="normal")
    col2.metric("IFR flights 2021", millify(FLT_2021), delta=round(((FLT_2021-FLT_2020)/FLT_2020)*100,2), delta_color="normal")
